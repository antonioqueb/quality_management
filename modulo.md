...
<odoo>
    <data noupdate="0">
        ...
        <!--
            FOLIO-QM-ODOO18-077:
            En QI-024 el proceso operativo solicitado queda como
            "Sierras y Ranuradoras"; Remanejo se conserva solo como legacy
            para no romper inspecciones históricas, pero ya no forma parte
            de la ruta estándar obligatoria.
        -->
        <record id="process_type_remanejo" model="quality.process.type">
            <field name="name">Remanejo (Legacy)</field>
            <field name="sequence">51</field>
            <field name="active" eval="False"/>
            <field name="description">Proceso legado conservado para inspecciones históricas. Usar Sierras y Ranuradoras para nuevas capturas.</field>
        </record>
        ...
        <record id="process_type_sierras_ranuradoras" model="quality.process.type">
            ...
            <field name="capture_mode">full</field>
            <field name="require_measures" eval="True"/>
            <field name="require_additional_attributes" eval="False"/>
            <field name="zero_value_blocking" eval="True"/>

            <!-- Medidas y Propiedades no aplican en este apartado; la captura va en Ranurado / Corte Sierra. -->
            <field name="show_largo" eval="False"/>
            <field name="show_ancho" eval="False"/>
            <field name="show_espesor" eval="False"/>
            <field name="show_hexagono" eval="False"/>
        ...
        <!-- Ruta estándar: Laminadora -> Sierras y Ranuradoras -> Troquelado Plano. -->
        <record id="quality_route_estandar_l5" model="quality.process.route.line">
            ...
            <field name="notes">Paso obligatorio para Ranurado / Corte Sierra.</field>
        </record>
        ...
        <record id="quality_route_estandar_l7" model="quality.process.route.line">
            ...
            <field name="notes">Paso legacy inactivo; no bloquea el flujo nuevo.</field>
        </record>
...
## ./models/quality_ranura_fixes.py
```py
# -*- coding: utf-8 -*-
"""
...
<odoo>
    ...
    <template id="report_inspection_summary_ranura_qi024"
              inherit_id="quality_management.report_inspection_summary_document">

        <!-- FOLIO-QM-ODOO18-076: reporte con tolerancia y Corte Sierra separado. -->
        <xpath expr="//t[@t-if='doc.ranurado_ids']" position="replace">
            <t t-set="ranurado_lines"
               t-value="doc.ranurado_ids.filtered(lambda r: r.tipo_operacion == 'ranurado')"/>
            <t t-set="corte_sierra_lines"
               t-value="doc.ranurado_ids.filtered(lambda r: r.tipo_operacion == 'corte_sierra')"/>

            <t t-if="ranurado_lines">
                <h5>Ranurado</h5>
                <table class="table table-bordered table-sm">
                    <thead>
                        <tr class="table-active">
                    ...
                    <tbody>
                        <tr t-foreach="ranurado_lines" t-as="r">
                            <td><span t-field="r.sequence"/></td>
                            <td><span t-field="r.concepto"/></td>
                            <td class="text-center"><span t-field="r.medida_esperada"/></td>
                            <td class="text-center"><span t-field="r.medida"/></td>
                            <td class="text-center"><span t-field="r.unidad"/></td>
                            <td class="text-center">+/- <span t-field="r.tolerancia"/></td>
                            <td class="text-center"><span t-field="r.desviacion"/></td>
            ...
            <t t-if="corte_sierra_lines">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        <tr t-foreach="corte_sierra_lines" t-as="r">
                            <td><span t-field="r.sequence"/></td>
                            <td><span t-field="r.concepto"/></td>
                            <td class="text-center"><span t-field="r.medida_esperada"/></td>
                            <td class="text-center"><span t-field="r.medida"/></td>
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <tr t-foreach="doc.line_ids" t-as="attr">
                                        ...
                                        <td class="text-center">
                                            <t t-if="attr.is_not_applicable or attr.result == 'na'">—</t>
                                            <t t-elif="attr.attribute_type == 'float' and (attr.value_float or attr.allow_zero)">
                                                <span t-field="attr.value_float"/>
                                            </t>
                                            ...
                                            <t t-elif="attr.attribute_type == 'boolean'">—</t>
                                            <t t-else="">—</t>
                                        </td>
                                        <td class="text-center">
                                            <t t-if="not (attr.is_not_applicable or attr.result == 'na') and attr.attribute_type == 'float' and (attr.min_value or attr.max_value)">
                                                <span t-field="attr.min_value"/> - <span t-field="attr.max_value"/> <span t-field="attr.unit"/>
                                            </t>
                                        </td>
                                        <td class="text-center">
                                            <span t-if="attr.is_not_applicable or attr.result == 'na'">No aplica</span>
                                            <span t-elif="attr.result in ('cumple','ok')" style="color: green; font-weight: bold;">
                                                <span t-field="attr.result"/>
                                            </span>
                                            <span t-elif="attr.result in ('no_cumple','no_ok')" style="color: red; font-weight: bold;">
                                                <span t-field="attr.result"/>
                                            </span>
                                            <span t-else="" style="color: #6b7280;">Pendiente</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <tr t-foreach="doc.inspection_line_ids" t-as="line">
                                        ...
                                        <td class="text-center">
                                            <t t-if="line.is_not_applicable or line.result == 'na'">—</t>
                                            <t t-elif="line.attribute_type == 'float' and (line.value_float or line.allow_zero)">
                                                <span t-field="line.value_float"/>
                                            </t>
                                            ...
                                            <t t-elif="line.attribute_type == 'boolean'">—</t>
                                            <t t-else="">—</t>
                                        </td>
                                        <td class="text-center">
                                            <t t-if="not (line.is_not_applicable or line.result == 'na') and line.attribute_type == 'float' and (line.min_value or line.max_value)">
                                                <span t-field="line.min_value"/> - <span t-field="line.max_value"/>
                                            </t>
                                        </td>
                                        <td class="text-center">
                                            <t t-if="not (line.is_not_applicable or line.result == 'na')">
                                                <span t-field="line.unit"/>
                                            </t>
                                        </td>
                                        <td class="text-center">
                                            <span t-if="line.is_not_applicable or line.result == 'na'">
                                                No aplica
                                            </span>
                                            <span t-elif="line.result in ('cumple','ok')" style="color: green; font-weight: bold;">
                                                <span t-field="line.result"/>
                                            </span>
                                            <span t-elif="line.result in ('no_cumple','no_ok')" style="color: red; font-weight: bold;">
                                                <span t-field="line.result"/>
                                            </span>
                                            <span t-else="" style="color: #6b7280;">Pendiente</span>
                                        </td>
            ...
            <xpath expr="//notebook" position="inside">
                <page string="Calidad" name="quality"
                    ...
                    <div class="text-muted mt-2">
                        ...
                        Estos atributos se cargan automáticamente al seleccionar este producto.
                        Si deja <b>Tipo de Proceso</b> vacío, aplican al producto en cualquier proceso.
                        Si selecciona un proceso, aplican solo a ese producto dentro de ese proceso.
                    </div>
                </page>
            </xpath>
        </field>
                    ...
                    <notebook>
                        ...
                        <page string="Atributos Adicionales"
                            ...
                            <p class="text-muted" invisible="process_code in ('acabado_empaque', 'impresion')">
                                <i class="fa fa-info-circle"/>
                                Capture el valor real del atributo. Use <b>No aplica</b> solo cuando la plantilla lo permita explícitamente.
                            </p>

                            <field name="line_ids"
                                   context="{
                                       'default_capture_zone': 'additional',
                                       'default_result_mode': 'cumple',
                                       'default_attribute_type': 'boolean'
                                   }">
                                <list editable="bottom">
                                    <field name="process_code" column_invisible="1"/>
                                    <field name="strict_binary_result" column_invisible="1"/>
                                    <field name="capture_zone" column_invisible="1"/>
                                    <field name="result_mode" column_invisible="1"/>
                                    ...
                                    <field name="name"
                                           ...
                                           readonly="attribute_template_id"
                                           required="not attribute_template_id"
                                           placeholder="Ej. Aplicación de adhesivo, Medidas correctas..."/>
                                    ...
                                    <field name="value_float"
                                           string="Valor medido"
                                           invisible="attribute_type != 'float' or strict_binary_result or is_not_applicable"/>

                                    <field name="value_selection"
                                           string="Valor selección"
                                           invisible="attribute_type != 'selection' or strict_binary_result or is_not_applicable"
                                           placeholder="Capture una opción configurada"/>

                                    <field name="value_char"
                                           string="Valor texto"
                                           invisible="attribute_type != 'char' or strict_binary_result or is_not_applicable"/>

                                    <field name="value_ok_required"
                                           string="Resultado"
                                           invisible="attribute_type != 'boolean' or result_mode != 'ok' or strict_binary_result or is_not_applicable"/>

                                    <field name="value_cumple_required"
                                           string="Resultado"
                                           invisible="attribute_type != 'boolean' or result_mode != 'cumple' or is_not_applicable"/>

                                    <field name="allow_not_applicable"
                                           string="Permitir No aplica"
                                           readonly="attribute_template_id"
                                    ...
                                    <field name="result"
                                           ...
                                           widget="badge"
                                           readonly="1"
                                           invisible="attribute_type != 'float' or is_not_applicable"
                                           decoration-success="result in ('cumple','ok')"
                                           decoration-danger="result in ('no_cumple','no_ok')"/>
...
<odoo>
    ...
    <record id="view_quality_inspection_form_ranura_qi024" model="ir.ui.view">
        <field name="name">quality.inspection.form.ranura.qi024</field>
        <field name="model">quality.inspection</field>
        <field name="inherit_id" ref="quality_management.view_quality_inspection_form"/>
        <field name="arch" type="xml">

            <!-- FOLIO-QM-ODOO18-079: refuerza búsqueda de OP por HMP1/HMPx, producto, código y origen. -->
            <xpath expr="//field[@name='production_order_id']" position="attributes">
                <attribute name="context">{'quality_inspection_mrp_search': True, 'active_test': False}</attribute>
                <attribute name="domain">[]</attribute>
            </xpath>

            <!-- FOLIO-QM-ODOO18-076: Ranurado editable, sin default Cumple, con tolerancia estándar. -->
            <xpath expr="//page[@name='ranurado']" position="replace">
                <page string="Ranurado"
                      invisible="process_code != 'sierras_ranuradoras' or state == 'borrador'"
                      name="ranurado">
                    <div class="alert alert-info" role="alert">
                        <i class="fa fa-info-circle"/>
                        Capture la medida real. Si existe medida esperada y está activo
                        <b>Evaluar por tolerancia</b>, el resultado se calcula con la tolerancia
                        estándar: <b>+/- 3 mm</b> o <b>+/- 1/8 in</b>. Si no hay nominal,
                        seleccione manualmente Cumple / No Cumple / N/A.
                    </div>
                    <group>
                        <field name="ranurado_unit" string="Unidad predeterminada"/>
                    </group>
                    <field name="ranurado_ids"
                           domain="[('tipo_operacion', '=', 'ranurado')]"
                           context="{'default_unidad': ranurado_unit, 'default_tipo_operacion': 'ranurado'}">
                        <list editable="bottom">
                            <field name="sequence"/>
                            <field name="tipo_operacion" column_invisible="1"/>
                            <field name="concepto"/>
                            <field name="medida_esperada"/>
                            <field name="medida"/>
                            <field name="unidad"/>
                            <field name="tolerancia"/>
                            <field name="desviacion" readonly="1"/>
                            <field name="evaluar_por_tolerancia"/>
                ...
                <!-- FOLIO-QM-ODOO18-076: opción independiente solicitada para Corte Sierra. -->
                <page string="Corte Sierra"
                      invisible="process_code != 'sierras_ranuradoras' or state == 'borrador'"
                      name="corte_sierra">
                    <div class="alert alert-info" role="alert">
                        <i class="fa fa-info-circle"/>
                        Use esta pestaña cuando la validación corresponda a corte con sierra,
                        separada del ranurado. Aplica la misma lógica de tolerancia y selección manual.
                    </div>
                    <field name="corte_sierra_ids"
                           domain="[('tipo_operacion', '=', 'corte_sierra')]"
                           context="{'default_unidad': ranurado_unit, 'default_tipo_operacion': 'corte_sierra', 'default_concepto': 'Corte Sierra'}">
                        <list editable="bottom">
                            <field name="sequence"/>
                            <field name="tipo_operacion" column_invisible="1"/>
                            <field name="concepto"/>
            ...
            <form string="Liberación de Muestra">
                <header>
                    ...
                    <button name="action_submit_inspection"
                            string="Enviar a Inspección"
                            type="object"
                            class="btn-primary"
                            invisible="state != 'borrador'"/>
                    <button name="action_accept"
                            string="Liberar (Aceptado)"
                            type="object"
                            class="btn-primary"
                    ...
                    <button name="action_reject"
                            ...
                            invisible="state != 'en_inspeccion'"
                            groups="quality_management.group_quality_inspector"/>
                    <button name="action_print_sample_release"
                            string="Imprimir"
                            type="object"
                            class="btn-secondary"
                            icon="fa-print"/>
                ...
                <sheet>
                    ...
                    <group>
                        <group string="Tipo y Datos">
                            ...
                            <field name="project_task_id"
                                   domain="['|', ('project_id', '=', 12), ('project_id.name', '=', 'Muestras &amp; Prototipos')]"
                                   context="{'default_project_id': 12}"
                                   options="{'no_create': True, 'no_create_edit': True, 'no_quick_create': True}"/>
                            <field name="product_id"/>
                            <field name="requested_by"/>
                            <field name="inspector_id"
                    ...
                    <notebook>
                        ...
                        <page string="Atributos de Inspección" name="attrs">
                            <div class="alert alert-info" role="alert">
                                <i class="fa fa-info-circle"/>
                                Puede seleccionar una plantilla existente o dejar <b>Plantilla</b> vacío para capturar un atributo manual.
                                Los atributos manuales permiten definir nombre, tipo de dato, opciones, rango y si admiten No aplica.
                            </div>
                            ...
                            <field name="inspection_line_ids"
                                ...
                                <list editable="bottom">
                                    ...
                                    <field name="name"
                                           string="Nombre del atributo"
                                           readonly="attribute_template_id"
                                           placeholder="Ej. Color/Tono, Registro, Empaque..."/>
                                    ...
                                    <field name="value_selection"
                                           string="Valor selección"
                                           invisible="attribute_type != 'selection' or is_not_applicable"
                                           placeholder="Capture una opción configurada"/>

                                    <field name="value_char"
                                           string="Valor texto"
                                           invisible="attribute_type != 'char' or is_not_applicable"/>

                                    <field name="value_cumple_required"
                                           string="Cumple/No cumple"
                                           invisible="attribute_type != 'boolean' or is_not_applicable"/>
